        ...
        While Not Fin
            ...
            If Not Fin Then
                ...
                If R2!idInci = R1!idInci Then
                    ...
                    End If
                    T1 = T2 - T1
                    C = "UPDATE tmpinciman SET horas= " & TransformaComasPuntos(CStr(T1))
                    C = C & " WHERE idtrabajador = " & R1!idTrabajador
                    C = C & " AND fecha=#" & Format(R1!Fecha, FormatoFecha) & "#"
                    C = C & " AND idinci = " & R1!idInci
                    Conn.Execute C
                    Fin = True
                End If
